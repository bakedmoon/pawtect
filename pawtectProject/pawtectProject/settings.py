"""
Django settings for pawtectProject project.
...
SECRET_KEY = 'gdyk8)l(8^ps4smz69ekfn(5a5eldqhrn3*py#3!+#1rk9$!+0'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'pawtectApp/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DEFAULT_FROM_EMAIL = 'sagar.crive@gmail.com'
SERVER_EMAIL = 'sagar.crive@gmail.com'
EMAIL_USE_TLS = True
